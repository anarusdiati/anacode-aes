/*
Referensi:
	Video dari channel YouTube "What's a Creel"
	
Keterangan:
	1. Kode yang ada di dalam file ini hanya bekerja untuk AES-128 bit saja.	
	2. Plaintext hanya bisa diubah di dalam variabel yang ada di fungsi main,
	   belum menerima input dari user yang dimasukkan melalui keyboard. Jadi,
	   jika ingin mengenkripsi plaintext yang lain, maka harus mengubah isi
	   variable plaintext yang ada di fungsi main.
	3. Key hanya bisa diubah di dalam variabel yang ada di fungsi main,
	   belum menerima input dari user yang dimasukkan melalui keyboard. Jadi,
	   jika ingin mengganti key yang lain, maka harus mengubah isi variable 
	   key yang ada di fungsi main. 
	4. Kode yang ada di dalam file ini sudah bisa memberikan padding apabila
	   panjang plaintext kurang atau lebih dari 16 bit.
*/
